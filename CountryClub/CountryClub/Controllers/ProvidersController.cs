...
namespace CountryClub.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public ProvidersController(CountryClubDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProviderId,Firstname,Lastname,Cellphone,Email,Password")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProviderId,Firstname,Lastname,Cellphone,Email,Password")] Provider provider)
        {
